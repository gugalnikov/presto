...
public class PlainTlsAuthenticatorFactory
        implements CertificateAuthenticatorFactory
{
    ...
    public CertificateAuthenticator create(Map<String, String> config)
    {
        Bootstrap app = new Bootstrap(
                binder -> {
                    configBinder(binder).bindConfig(PlainTlsConfig.class);
                    binder.bind(PlainTlsAuthenticator.class).in(Scopes.SINGLETON);
                });
        ...
        return injector.getInstance(PlainTlsAuthenticator.class);
    }
}
