...
public class CertificateAuthenticatorManager
{
    ...
    private final AtomicReference<io.prestosql.spi.security.CertificateAuthenticator> authenticator = new AtomicReference<>();
            ...
            throws Exception
    {
        ...
        io.prestosql.spi.security.CertificateAuthenticator authenticator = factory.create(ImmutableMap.copyOf(properties));
